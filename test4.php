...
<head>
    ...
    <script>
        ...
        function calculateTotal() {
            ...
            let discountAmount = parseFloat(document.querySelector('input[name="discountAmount"]:checked').value) || 0;
...
<body>
    ...
    <!-- Contact Information Section -->
        ...
        <label for="discountType">discountType ($):</label><br>
        <input type="radio" id="discountType0" name="discountType" value="0" onchange="calculateTotal()">
        <label for="discountType0">$0</label><br>
        <input type="radio" id="discountType5" name="discountType" value="5" onchange="calculateTotal()">
        <label for="discountType5">$5</label><br>
        <input type="radio" id="discountType10" name="discountType" value="10" onchange="calculateTotal()">
        <label for="discountType10">$10</label>
        <input type="radio" id="discountType15" name="discountType" value="15" onchange="calculateTotal()">
        <label for="discountType15">$15</label><br><br>
